...
const Header = () => {
  // change theme - save in local storage
  const localStorageDark = localStorage.getItem("isdark");
  const [isdark, setIsdark] = useState<boolean>(localStorageDark === null ? true : localStorageDark === "true");
  useEffect(() => {
  ...
  return (
    <header>
      <div className="navbar bg-base-200 bg-opacity-95 shadow-lg fixed top-0 py-0">
        ...
        <div className="navbar-end me-3">
          ...
          <label className="swap swap-rotate">
            <input type="checkbox" className="theme-controller" value={isdark ? "night" : "retro"} checked={isdark} onChange={() => setIsdark(!isdark)} />
